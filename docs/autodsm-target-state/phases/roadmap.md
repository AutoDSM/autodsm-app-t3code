...
1. **Wedge alignment** — Does it strengthen prompt → preview → diff → merge? _(Required: yes)_
2. **Local-first integrity** — Source/secrets/scans stay on machine? _(Required: yes or opt-in)_
3. **Artifact discipline** — Can it be modeled as a stable artifact? _(Required: yes)_
