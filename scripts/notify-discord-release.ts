  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new AutoDSM prerelease is available for nightly testers."
          : "A new AutoDSM latest release is available.",
...
).pipe(Command.withDescription("Post a AutoDSM release announcement to Discord."));
