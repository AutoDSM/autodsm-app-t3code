...
export const COMPOSER_INLINE_BRAND_TOKEN_CHIP_CLASS_NAME =
  "inline-flex max-w-full select-none items-center gap-1 rounded-md border border-brand/45 bg-brand/10 px-1.5 py-px font-medium text-[12px] leading-[1.1] text-brand align-middle";
