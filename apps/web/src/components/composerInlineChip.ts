...
export const COMPOSER_INLINE_BRAND_TOKEN_CHIP_CLASS_NAME =
  "inline-flex max-w-full select-none items-center gap-1 rounded-md border border-[#8a38f5]/45 bg-[#8a38f5]/10 px-1.5 py-px font-medium text-[12px] leading-[1.1] text-[#8a38f5] align-middle dark:text-[#c084fc]";
