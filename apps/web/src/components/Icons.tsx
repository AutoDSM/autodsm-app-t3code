...
/** Standard four-color Google "G" per Sign in with Google branding guidelines. */
export const GoogleIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 18 18" aria-hidden>
    <path
    ...
    />
    <path
      d="M9 3.58c1.321 0 2.507.454 3.438 1.345l2.582-2.58C13.463.891 11.426 0 9 0A8.997 8.997 0 0 0 .957 4.958L3.964 7.29C4.672 5.163 6.656 3.58 9 3.58z"
      fill="#EA4335"
    />
  </svg>
);
