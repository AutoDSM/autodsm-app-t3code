...
const rpcClientMock = {
  ...
  autodsm: {
    ...
    getComponentRegistryEntry: vi.fn(),
    getRenderEnvironmentProfile: vi.fn(),
    getRenderManifest: vi.fn(),
    getScanArtifact: vi.fn(),
    subscribeIndexingProgress: vi.fn(() => () => undefined),
    runScan: vi.fn(),
    buildRenderPlan: vi.fn(),
    executeRenderPlan: vi.fn(),
    getSidecarStatus: vi.fn(),
    startSidecar: vi.fn(),
    getProviderCatalog: vi.fn(),
    changeSetCreate: vi.fn(),
    changeSetPreview: vi.fn(),
    changeSetApply: vi.fn(),
    changeSetRollback: vi.fn(),
    assembleGenerationPlan: vi.fn(),
    exportPublishedSnapshot: vi.fn(),
    prepareSessionBranch: vi.fn(),
    getIssuesForPrompt: vi.fn(),
