...
export const BACKEND_STATUS_CHANNEL = "desktop:backend-status";
export const RESTART_DESKTOP_BACKEND_CHANNEL = "desktop:restart-backend";
...
export const COMPONENT_PREVIEW_ATTACH_CHANNEL = "desktop:component-preview:attach";
