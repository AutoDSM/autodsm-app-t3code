...
import { PRODUCT_BASE_NAME, resolveProductDisplayName } from "@t3tools/shared/productBranding";
...
function resolveDesktopAppBranding(input: {
  ...
  return {
    ...
    stageLabel,
    displayName: resolveProductDisplayName(stageLabel),
  };
}
...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  return DesktopEnvironment.of({
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "com.autodsm.app.dev" : "com.autodsm.app",
    linuxDesktopEntryName: isDevelopment ? "autodsm-dev.desktop" : "autodsm.desktop",
    linuxWmClass: isDevelopment ? "autodsm-dev" : "autodsm",
    userDataDirName,
